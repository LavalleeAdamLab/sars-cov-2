...
public class Calculator {
    ...
    public static int countNumberOfInteractionsPerProtein(Protein proteinOfInterest, ArrayList<Interaction> networkPPIList) {
        ...
        for (int i = 0; i < networkPPIList.size(); i++) {
            ...
            String proteinInteractor1 = networkPPIList.get(i).getID1();
            String proteinInteractor2 = networkPPIList.get(i).getID2();

            if (proteinOfInterest.getProteinId().equals(proteinInteractor1) || proteinOfInterest.getProteinId().equals(proteinInteractor2)) {
                interactionCounter++;
            }
        }
...
//		return shuffledAnnotationGoList;
    ...
    public static HashSet<String> determineUniProtIDsInNetwork(ArrayList<Protein> proteinsInNetworkList) {
        ...
        HashSet<String> uniProtIDsInNetwork = new HashSet<String>();
