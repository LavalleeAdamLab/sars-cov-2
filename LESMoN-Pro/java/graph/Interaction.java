...
public class Interaction {
	...
	private final static double DEFAULT_WEIGHT = 1.0;
		...
		// constructors
		public Interaction(String _Protein1, String _Protein2, String _ID1, String _ID2) {
			this(_Protein1, _Protein2, _ID1, _ID2, DEFAULT_WEIGHT);
		}
		
		public Interaction(String _Protein1, String _Protein2, String _ID1, String _ID2, double _w) {
			Protein1 = _Protein1;
			Protein2 = _Protein2;
			ID1 = _ID1;
			ID2 = _ID2;
