...
public class Cleaner {
    ...
    private SignificanceCalculator fdrCalculator;
     ...
     */
    public Cleaner(Annotation cluster, double[][] distanceMatrix, String distributionParametersFilePath, double removalPValueCondition, SignificanceCalculator fdrCalculator) {
