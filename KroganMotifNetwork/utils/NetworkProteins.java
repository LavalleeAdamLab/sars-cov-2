...
public class NetworkProteins {
    ...
    public static ArrayList<Protein> getProteinsInNetwork(ArrayList<Interaction> InteractionList) {
        ...
        while (iterator.hasNext()) {
            ...
            String protId = getProteinId(proteinName, InteractionList);
    ...
    private static String getProteinId(String protName, ArrayList<Interaction> interactionList) {
        ...
        while (foundID == false) {
            ...
            // interaction.
            if (inter.getProtein1().equals(protName)) {
                protId = inter.getID1();
                j = 0;
                foundID = true;
            } else if (inter.getProtein2().equals(protName)) {
                protId = inter.getID2();
                j = 0;
                foundID = true;
            } else {
