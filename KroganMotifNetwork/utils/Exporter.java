...
//		pvalToTest.addAll(Arrays.asList(0.1, 0.05, 0.01, 0.005, 0.001));
    ...
    public static void exportAnnotationInfoForFDRcalc(ArrayList<Annotation> annotationList, String outputFile) {
    	  try {
              BufferedWriter out = new BufferedWriter(new FileWriter(new File(outputFile)));
              out.write("Motif\tP-value\n");
              
              for(Annotation annotation: annotationList) {
            	  out.write(annotation.getName() + "\t" + annotation.getPvalue() + "\n");
            	  out.flush();
              }
